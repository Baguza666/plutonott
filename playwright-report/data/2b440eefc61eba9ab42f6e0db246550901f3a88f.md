...
- Name: whatsapp-links.spec.ts >> Intégrité des CTA WhatsApp >> Test Javascript désactivé (Fallback WhatsApp)
- Location: tests/e2e/whatsapp-links.spec.ts:45:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:8923/
Call log:
  - navigating to "http://localhost:8923/", waiting until "load"
