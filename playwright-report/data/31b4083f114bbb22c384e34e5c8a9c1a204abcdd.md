...
- Name: seo-status.spec.ts >> Contrôles SEO (Noindex & Publication Status) >> La route /comparatif/mario-iptv/ doit être en noindex (blocked)
- Location: tests/e2e/seo-status.spec.ts:13:11

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:8923/comparatif/mario-iptv/
Call log:
