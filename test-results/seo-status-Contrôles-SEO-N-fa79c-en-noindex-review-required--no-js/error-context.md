...
- Name: seo-status.spec.ts >> Contrôles SEO (Noindex & Publication Status) >> La route /comparatif/flix-iptv/ doit être en noindex (review_required)
- Location: tests/e2e/seo-status.spec.ts:13:11

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:8923/comparatif/flix-iptv/
Call log:
  - navigating to "http://localhost:8923/comparatif/flix-iptv/", waiting until "load"
