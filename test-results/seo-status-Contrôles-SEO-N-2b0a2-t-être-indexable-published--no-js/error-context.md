...
- Name: seo-status.spec.ts >> Contrôles SEO (Noindex & Publication Status) >> La route /iptv-france/abonnement/ doit être indexable (published)
- Location: tests/e2e/seo-status.spec.ts:38:11

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:8923/iptv-france/abonnement/
Call log:
  - navigating to "http://localhost:8923/iptv-france/abonnement/", waiting until "load"
