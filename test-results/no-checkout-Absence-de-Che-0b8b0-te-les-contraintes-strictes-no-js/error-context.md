...
- Name: no-checkout.spec.ts >> Absence de Checkout et de Paiement >> Page /tarifs-grossiste/ respecte les contraintes strictes
- Location: tests/e2e/no-checkout.spec.ts:30:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:8923/tarifs-grossiste/
Call log:
  - navigating to "http://localhost:8923/tarifs-grossiste/", waiting until "load"
