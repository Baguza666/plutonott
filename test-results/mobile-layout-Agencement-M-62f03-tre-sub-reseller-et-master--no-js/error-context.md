...
- Name: mobile-layout.spec.ts >> Agencement Mobile et Scroll Horizontal >> Vérification du layout sur la route: /revendeur/choisir-entre-sub-reseller-et-master/
- Location: tests/e2e/mobile-layout.spec.ts:15:9

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:8923/revendeur/choisir-entre-sub-reseller-et-master/
Call log:
